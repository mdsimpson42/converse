...
are linked on our [resources page]({{site.baseurl}}/resources/tips), but I wanted to list some of
them here and discuss my experiences with each of them.

---

As with a lot of things on this site, it should be noted that this based on is MY experience,
yours may vary.
...
and provide different services. Hopefully this will give you a few possible starting points.
...
and do what they can, even if that is just signposting other resources.
...
which only makes things worse. But don't worry, there are other places you can go to get help.
...
They are trained to be discreet and approachable, so you should be able to talk to them with confidence.
...
There are many different types of therapy available, including Cognitive Behavioural Therapy (CBT), counselling and
...
Alternatively, you can pay for private therapy, which can be expensive but may be available more quickly.
...
Seeking help for mental health issues can be daunting, and will require perseverance and hard work,
